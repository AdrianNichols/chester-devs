...
namespace MeetupCrawler
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for(int pages = 1; pages <= 11; pages++)
            {
            ...
            foreach (Person person in people)
            {
                ...
                interests.AddRange(memberPage.Html.CssSelect("li.D_group > div#topicList3 > a.topic-widget").Select<HtmlNode, Interest>(i => new Interest() { Name = i.InnerText }).ToList());
